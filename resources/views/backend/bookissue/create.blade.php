...
@endif
                    ...
                    <form action="{{ route('admin.book-issues.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                             <div class="col-md-6">
                           ...
                           @error('user_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="issue_date" id="category_name" class="form-control" placeholder="Enter Issue Date">
                                </div>
                                @error('issue_date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="return_date" id="category_name" class="form-control" placeholder="Enter Return Date">
                                </div>
                                @error('return_date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="book_id" id="status" class="form-control" required>
